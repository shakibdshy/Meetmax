import { Avatar, Button, Grid, Group, Input, MediaQuery } from '@mantine/core'
  ...
  return (
    <>
      <div className='input-field-section'>
        <Group spacing='sm' style={{ flexWrap: "nowrap", paddingBottom: '10px', borderBottom: "1px solid #3a3b3c" }}>
